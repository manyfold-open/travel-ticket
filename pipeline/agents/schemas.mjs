export const BRIEF_SCHEMA = {
  ...
  properties: {
    ...
    language: { type: 'string', enum: ['en-GB', 'zh-CN'], description: 'Output language for all user-facing copy. Use the requested language.' },
  ...
  properties: {
    ...
    days: {
      ...
      items: {
        ...
        properties: {
          ...
          base: { type: 'string' },
          handwritten_note: { type: 'string', description: 'Optional. One colloquial reminder (≤22 chars) in the requested output language. Must paraphrase an existing warning/note for this day — never introduce new facts. Omit when nothing is worth writing.' },
    ...
    cover: {
      ...
      properties: {
        ...
        eyebrow: { type: 'string' },
        handwritten_note: { type: 'string', description: 'Optional. One trip-level colloquial reminder (≤22 chars) in the requested output language; paraphrase the most human warning, no new facts.' },
      },
